...
public class ModArmorMaterials {
    ...
    static int HELMET_DEFENSE = 5;
    static int CHESTPLATE_DEFENSE = 9;
    static int LEGGINGS_DEFENSE = 7;
    static int BOOTS_DEFENSE = 5;
    static int OVERALL_DEFENSE = 11;

    static int ENCHANTABILITY_OF_PYRONITE_ARMOR = 15;
    static float TOUGHNESS_OF_PYRONITE_ARMOR = 4f;
