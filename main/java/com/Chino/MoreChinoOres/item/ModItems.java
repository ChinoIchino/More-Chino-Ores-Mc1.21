...
public class ModItems{
    ...
    //SPAWNABLE ENTITIES
    public static final RegistryObject<Item> RED_JELLY_EGG = ITEMS.register("red_jelly_egg",
        () -> new ForgeSpawnEggItem(ModEntities.RED_JELLY, 0xa88f91, 0xdb1828, new Item.Properties()));
