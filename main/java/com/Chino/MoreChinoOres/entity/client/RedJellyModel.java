...
public class RedJellyModel<T extends RedJellyEntity> extends HierarchicalModel<T> {
	...
	public RedJellyModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Layers = partdefinition.addOrReplaceChild("Layers", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
